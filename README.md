...
**EchoType v0.9.0 Beta** is a hybrid release candidate on
`codex/v0.9-stable-release`. It starts from the manually proven V2 backend commit
`195f72930c345275a8dd1d92cc571dfaf24e4db6` and selectively carries forward the v0.9 UI,
branding, and release documentation. It still awaits the final manual Windows validation listed in
