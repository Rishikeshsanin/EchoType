...
- [x] Release branch is `codex/v0.9-stable-release`, not `develop` or `main`
- [x] V2 runtime/audio/transcription/hotkey delivery behavior remains the backend baseline
...
- [x] `python -m pytest -q` — 138 passed on the hybrid release-preparation environment
