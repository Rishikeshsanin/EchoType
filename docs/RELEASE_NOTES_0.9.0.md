...
EchoType v0.9.0 Beta is the hybrid public-release candidate for the redesigned privacy-first Windows
voice-typing application. It combines the manually proven V2 dictation, focus-capture, and
paste-back backend with the polished v0.9 interface, language selector, recording visualization,
branding, and release material.
...
The hybrid release-preparation branch passes 138 hardware-independent Python, Qt offscreen, privacy,
